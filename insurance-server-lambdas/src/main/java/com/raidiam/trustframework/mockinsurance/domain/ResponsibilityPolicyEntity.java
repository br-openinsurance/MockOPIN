...
public class ResponsibilityPolicyEntity extends BaseEntity implements HasStatusInterface {
        ...
        return new ResponseInsuranceResponsibilityPolicyInfo()
                .data(new InsuranceResponsibilityPolicyInfoData()
                        ...
                        .insuredObjects(List.of(new InsuranceResponsibilityInsuredObject()
                                ...
                                .type(InsuranceResponsibilityInsuredObject.TypeEnum.CONTRATO)
                                .description("string")
    ...
    public ResponseInsuranceResponsibilityPolicyInfoV2 mapPolicyInfoDTOV2() {
        return new ResponseInsuranceResponsibilityPolicyInfoV2()
                .data(new InsuranceResponsibilityPolicyInfoDataV2()
                        .documentType(InsuranceResponsibilityPolicyInfoDataV2.DocumentTypeEnum.APOLICE_INDIVIDUAL)
                        .policyId("1111111")
                        .susepProcessNumber("string")
                        .groupCertificateId("string")
                        .issuanceType(InsuranceResponsibilityPolicyInfoDataV2.IssuanceTypeEnum.EMISSAO_PROPRIA)
                        .issuanceDate(LocalDate.of(2022, 12, 31))
                        .termStartDate(LocalDate.of(2022, 12, 31))
                        .termEndDate(LocalDate.of(2023, 12, 31))
                        .leadInsurerCode("string")
                        ...
                        .insuredObjects(List.of(new InsuranceResponsibilityInsuredObjectV2()
                                .identification("string")
                                .type(InsuranceResponsibilityInsuredObjectV2.TypeEnum.CONTRATO)
                                .description("string")
                                .amount(new AmountDetails()
                                        .amount("9871667727569.12")
                                        .unitType(AmountDetails.UnitTypeEnum.MONETARIO)
