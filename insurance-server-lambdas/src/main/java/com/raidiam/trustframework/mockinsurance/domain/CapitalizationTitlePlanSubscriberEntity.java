        ...
        return new InsuranceCapitalizationTitleSubscriberV2()
                ...
                .subscriberAddress(new Address()
                    ...
                    .address((AllOfAddressAddress) new AllOfAddressAddress()
                        .allOfAddressAddressName(this.getSubscriberAddress().split(" ", 2)[1].split(",")[0])
                        .allOfAddressAddressNumber(this.getSubscriberAddress().split(" ", 2)[1].split(",")[1].trim())
                        .allOfAddressAddressAddressComplementaryInfo(this.getSubscriberAddressAdditionalInfo())
                        .allOfAddressAddressTownName(this.getSubscriberTownName())
                        .allOfAddressAddressCountrySubDivision(this.getSubscriberCountrySubDivision())
                        .allOfAddressAddressPostCode(this.getSubscriberPostcode())
                        ...
                        .number(this.getSubscriberAddress().split(" ", 2)[1].split(",")[1].trim())
