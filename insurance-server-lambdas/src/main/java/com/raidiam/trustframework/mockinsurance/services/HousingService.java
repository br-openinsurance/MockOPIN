...
public class HousingService extends BaseInsuranceService {
    ...
    private List<HousingPolicyEntity> getHousingPolicyEntities(Pageable pageable, String consentId) {
        ...
        InsuranceLambdaUtils.checkConsentPermissions(consentEntity, EnumConsentPermission.DAMAGES_AND_PEOPLE_HOUSING_READ, EnumConsentV3Permission.DAMAGES_AND_PEOPLE_HOUSING_READ);
    ...
    private HousingPolicyEntity getPolicy(UUID policyId, String consentId, EnumConsentPermission permission, EnumConsentV3Permission permissionV3) {
    ...
    public ResponseInsuranceHousingClaimsV2 getPolicyClaimsV2(UUID policyId, String consentId, Pageable pageable) {
        ...
        var claims = housingPolicyClaimRepository.findByHousingPolicyId(policyId, pageable);
        var resp = new ResponseInsuranceHousingClaimsV2()
                .data(claims.getContent().stream().map(HousingPolicyClaimEntity::mapDTOV2).toList());
        resp.setMeta(InsuranceLambdaUtils.getMeta(claims, false));
        return resp;
    }
    ...
    public ResponseInsuranceHousingPremium getPolicyPremium(UUID policyId, String consentId) {
        ...
        getPolicy(policyId, consentId, EnumConsentPermission.DAMAGES_AND_PEOPLE_HOUSING_PREMIUM_READ, EnumConsentV3Permission.DAMAGES_AND_PEOPLE_HOUSING_PREMIUM_READ);
