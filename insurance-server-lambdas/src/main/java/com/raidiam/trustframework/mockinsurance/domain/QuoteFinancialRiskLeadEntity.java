...
@Entity
@Audited
@Table(name = "quote_financial_risk_leads")
public class QuoteFinancialRiskLeadEntity extends QuoteEntity {

    public static QuoteFinancialRiskLeadEntity fromRequest(QuoteRequestFinancialRiskLead req, String clientId) {
