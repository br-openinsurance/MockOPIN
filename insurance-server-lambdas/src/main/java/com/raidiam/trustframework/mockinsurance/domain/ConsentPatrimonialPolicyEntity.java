...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "consent_patrimonial_policies")
public class ConsentPatrimonialPolicyEntity extends BaseEntity {
    @Id
    ...
    public ConsentPatrimonialPolicyEntity(ConsentEntity consent, PatrimonialPolicyEntity policy) {
