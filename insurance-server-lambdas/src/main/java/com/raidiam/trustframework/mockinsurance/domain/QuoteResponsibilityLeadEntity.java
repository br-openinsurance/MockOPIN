...
@Entity
@Audited
@Table(name = "quote_responsibility_leads")
public class QuoteResponsibilityLeadEntity extends QuoteEntity {

    public static QuoteResponsibilityLeadEntity fromRequest(QuoteRequestResponsibilityLead req, String clientId) {
        QuoteResponsibilityLeadEntity entity = new QuoteResponsibilityLeadEntity();
    ...
    public static QuoteResponsibilityLeadEntity fromRequestV2(QuoteRequestResponsibilityLeadV2 req, String clientId) {
        QuoteResponsibilityLeadEntity entity = new QuoteResponsibilityLeadEntity();
        entity.setConsentId(req.getData().getConsentId());
        entity.setStatus(QuoteStatus.StatusEnum.RCVD.toString());
        entity.setClientId(clientId);
