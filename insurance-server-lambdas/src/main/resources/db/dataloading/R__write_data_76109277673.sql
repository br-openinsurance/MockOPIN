...
DO $$DECLARE
    ...
    accountHolderName varchar := 'Usuário 1';
...
BEGIN
    ...
    PERFORM addRuralPolicyInsuredObjectCoverage(ruralPolicyInsuredObjectId1, '0111', 'GRANIZO', 'string', 'string', 'string', '611314175958997.73', 'PORCENTAGEM', 'Horas', 'R$', 'BRL', true, '2022-12-31', '2022-12-31', true, 'MASSIFICADOS', 'PARAMETRICO', 0, 'DIA', 'UTEIS', '2022-12-31', '2022-12-31', 'MENSAL', 'string');
    ruralPolicyCoverageDeductibleId1 := addDeductible('DEDUTIVEL', 'string', '20422775042005.26', 'PORCENTAGEM', 'Horas', 'R$', 'BRL', 10, 'DIA', 'UTEIS', '2022-05-16', '2022-05-17', 'Franquia de exemplo');
