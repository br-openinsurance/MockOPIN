CREATE TABLE acceptance_and_branches_abroad_policies (
...
CREATE TABLE acceptance_and_branches_abroad_policies_aud (
    policy_id                                           UUID,
    insurance_id                                        VARCHAR,
    status                                              VARCHAR,
    account_holder_id                                   UUID,
...
CREATE TABLE acceptance_and_branches_abroad_policy_claims (
    ...
    updated_by                                                  VARCHAR,
    hibernate_status                                            VARCHAR,
    FOREIGN KEY (policy_id) REFERENCES acceptance_and_branches_abroad_policies (policy_id) ON DELETE CASCADE
);

CREATE TABLE acceptance_and_branches_abroad_policy_claims_aud (
    claim_id                                                    UUID,
    policy_id                                                   UUID,
    identification                                              VARCHAR,
    rev                                                         INTEGER NOT NULL,
...
CREATE TABLE consent_acceptance_and_branches_abroad_policies
(
...
CREATE TABLE consent_acceptance_and_branches_abroad_policies_aud
(
