CREATE TABLE patrimonial_policies (
...
CREATE TABLE patrimonial_policies_aud (
    policy_id                                           UUID,
    insurance_id                                        VARCHAR,
    status                                              VARCHAR,
    account_holder_id                                   UUID,
...
CREATE TABLE patrimonial_policy_claims (
...
CREATE TABLE patrimonial_policy_claims_aud (
    claim_id                                                    UUID,
    policy_id                                                   UUID,
    identification                                              VARCHAR,
    rev                                                         INTEGER NOT NULL,
...
CREATE TABLE consent_patrimonial_policies
(
...
CREATE TABLE consent_patrimonial_policies_aud
(
