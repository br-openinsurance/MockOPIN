...
//@Singleton
//@Primary
class TestAuthFetcher implements AuthenticationFetcher<HttpRequest<?>> {
    ...
    Publisher<Authentication> fetchAuthentication(HttpRequest<?> request) {
        ...
        if (request instanceof APIGatewayProxyRequestEvent) {
            ...
            ApiGatewayProxyServletRequest<?> micronautRequest = (ApiGatewayProxyServletRequest) request;
